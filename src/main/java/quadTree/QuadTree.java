...
/*	public static void main(String[] args) {
        ...
        QuadTree<Integer, String> qd1 = new QuadTree<Integer, String>();
        for(int i = 0; i < 4; i++)
            for(int j = 0; j < 4; j++)
        ...
        QuadTree<Integer, String> qd2 = new QuadTree<Integer, String>();
...
//		if(eq(x, h.x) && eq(y, h.y)) h.value = value;	// duplicate
  ...
  /***********************************************************************
    ...
    ***************************************************************************/
    ...
    private void query2D(QuadTreeNode h, Interval2D<Key> rect) {
        if (h == null) return;
